...
function Bookings() {
  ...
  const menuDetails = (details)=>{
    //const menuitem =details.menuItems; 
    setMenu(details);
  }
  console.log(menu);
            ...
            <div className="bookingsRow" key={index}>
              ...
              <li className="bookingrowItem">
                <button
                  ...
                  key={index}
                  onClick={() => {
                    setShowrest(true); restDetails(details.restaurantId);
                  }}
                >
                  Restaurant
                </button>
                {showrest && (
<Modal show={showrest} onHide={handleEditClose} size="m" centered animation >
...
<Modal.Body>
 <div className="restaurant">
  ...
  <p>Phone Number: {restaurant[0].phonenumber}</p>
              ...
              <li className="bookingrowItem"><button
                  className="itembtn"
                  key={index}
                  onClick={() => {
                    setShowmenu(true); menuDetails(details.menuItems);
                  }}
                >
                  Menu
                </button></li>
