...
import { createWallet, deleWallet, walletInfo } from '../../../../actions/UserActions';
import "./Mywallet.css"
        ...
        {Object.keys(wallet).length  ? ( 
          ...
          <div className="walletRow">
            ...
            <div className="deleBtn">
              <FontAwesomeIcon className='btnDel' icon={faTrash} onClick={Delewallet}/>
            </div>
          </div>
          ...
          <button className="walletCreate" onClick={()=> setShowWallet(true)}>Create Wallet
        ...
        <Modal.Body>
          <div className="modalInp">
            <div className="inp">
              ...
              <input type="text" name="accountname" value={walletinfo?.accountname}  onChange={handleChange} />
            </div>
            <div className="inp">
              <label htmlFor="">Account Number:</label>
              <input type="number" name="cardnumber" value={walletinfo?.cardnumber} onChange={handleChange} />
            </div>
          </div>
